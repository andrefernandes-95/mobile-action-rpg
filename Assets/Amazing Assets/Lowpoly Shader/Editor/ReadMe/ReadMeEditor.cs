...
namespace AmazingAssets.LowpolyShader.Editor
{
    ...
    public class ReadMeEditor : UnityEditor.Editor
    {
        ...
        protected override void OnHeaderGUI()
        {
            ...
            GUILayout.BeginHorizontal("In BigTitle");
            {
                ...
                if (GUI.Button(logoRect, Logo))
                    Application.OpenURL(LowpolyShaderAbout.storeURL);
                ...
                GUILayout.BeginVertical();
                {
                    ...
                    GUILayout.Label(LowpolyShaderAbout.name, GUIStyleTitle);
                    GUILayout.Label("Version " + LowpolyShaderAbout.version, EditorStyles.centeredGreyMiniLabel);
                    GUILayout.FlexibleSpace();
                }
        ...
        public override void OnInspectorGUI()
        {
            ...
            //Documentation
            {
                ...
                if (LinkLabel(new GUIContent("Open online documentation")))
                    Application.OpenURL(LowpolyShaderAbout.documentationURL);
            }
            ...
            //Forum
            {
                ...
                if (LinkLabel(new GUIContent("Get answers")))
                    Application.OpenURL(LowpolyShaderAbout.forumURL);
            }
            ...
            //Support
            {
                ...
                if (LinkLabel(new GUIContent("Submit a report")))
                    Application.OpenURL("mailto:" + LowpolyShaderAbout.supportMail);
            }
            ...
            //Support
            {
                ...
                if (LinkLabel(new GUIContent("Open publisher page")))
                    Application.OpenURL(LowpolyShaderAbout.publisherPage);
            }
        }
        ...
        {
            string fileName = "AmazingAssets.LowpolyShader.Editor";
